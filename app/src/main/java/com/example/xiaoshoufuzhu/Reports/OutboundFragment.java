...
public class OutboundFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvCustomerQuantity = view.findViewById(R.id.tvCustomerQuantity);
        tvSalesQuantity = view.findViewById(R.id.tvSalesQuantity);
        tvCustomerTotalPrice = view.findViewById(R.id.tvCustomerTotalPrice);
        tvSalesTotalPrice = view.findViewById(R.id.tvSalesTotalPrice);
        tvReceivableAmount = view.findViewById(R.id.tvReceivableAmount);
        tvTotalReceivable = view.findViewById(R.id.tvTotalReceivable);
        tvTotalIncome = view.findViewById(R.id.tvTotalIncome);
        btnReceivableInfo = view.findViewById(R.id.btnReceivableInfo);
        btnCustomerDetails = view.findViewById(R.id.btnCustomerDetails);
        llReceivableDetails = view.findViewById(R.id.llReceivableDetails);
        llCustomerDetails = view.findViewById(R.id.llCustomerDetails);
        svCustomerDetails = view.findViewById(R.id.svCustomerDetails);
        svReceivableDetails = view.findViewById(R.id.svReceivableDetails);
        ...
        new Thread(() -> {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    // Log the details
                    Log.i("OutboundFragment", "Processed record: rc_id=" + rcId + ", s_id=" + sId + ", customer_quantity=" + customerQuantity + ", customer_total_price=" + customerTotalPrice + ", receivable_amount=" + receivableAmount + ", sales_quantity=" + salesQuantity + ", sales_total_price=" + salesTotalPrice + ", total_receivable=" + totalReceivable + ", total_income=" + totalIncome);
                }
    ...
    private void loadReceivableDetails(String productName, String productNum) {
        new Thread(() -> {
            ...
            try {
                ...
                getActivity().runOnUiThread(() -> populateReceivableDetails(receivableDetails));
    ...
    private void loadCustomerDetails(String productName, String productNum) {
        new Thread(() -> {
            ...
            try {
                ...
                getActivity().runOnUiThread(() -> populateCustomerDetails(customerDetails));
    ...
    private void populateReceivableDetails(List<ReceivableDetail> receivableDetails) {
        ...
        for (ReceivableDetail detail : receivableDetails) {
            TextView tvReceivableDetail = new TextView(getActivity());
            ...
            tvReceivableDetail.setTextColor(ContextCompat.getColor(getActivity(), R.color.textPrimary));
    ...
    private void populateCustomerDetails(List<CustomerDetail> customerDetails) {
        ...
        for (CustomerDetail detail : customerDetails) {
            TextView tvCustomerDetail = new TextView(getActivity());
            tvCustomerDetail.setLayoutParams(new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT
            ));
            tvCustomerDetail.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
            tvCustomerDetail.setTextColor(ContextCompat.getColor(getActivity(), R.color.textPrimary));
